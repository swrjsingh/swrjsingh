...
🌟 Building a SOTA reasoning-based LLM app fine-tuned to solve doubts with generated video and text-based solutions to any (JEE Advanced) problem in multiple languages. <br>
