...
🔍 Currently focused on Speech Synthesis using NVIDIA's Riva and NeMo and building LLM Pipelines using WandB<br>
⚡ Learning Reasoning within LLMs and Agents, all about ORCA, ReAct and BAGEL<br>
🌟 Building a SOTA reasoning-based LLM app to solve doubts with locally generated video-based solutions to any (JEE Advanced) problem in multiple languages. <br>
